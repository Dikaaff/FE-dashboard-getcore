import { Search, Menu, User, LogOut, ChevronDown, Bot, Package, Settings } from 'lucide-react';
...
export function AdminTopBar({ onMenuClick, onNavigate, onLogout }: AdminTopBarProps) {
  const handleLogout = () => {
            ...
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 hover:bg-white rounded-lg px-2 py-1.5 transition-all duration-200 hover:shadow-sm group">
                <Avatar className="w-8 h-8 border-2 border-gray-200/60 group-hover:border-[#8a25ed]/30 transition-colors">
                  ...
                  <AvatarFallback className="bg-[#8a25ed] text-white text-xs">SA</AvatarFallback>
                </Avatar>
                <div className="hidden lg:block text-left">
                  <p className="text-xs text-gray-900">Super Admin</p>
