...
import { User, Mail, Phone, Camera, Eye, EyeOff, Lock } from 'lucide-react';
...
export function UserProfileContent() {
  const [profileData, setProfileData] = useState({
    fullName: 'John Doe',
    email: 'user@getcore.id',
    phone: '+62 812-3456-7890',
    profilePhoto: 'https://api.dicebear.com/7.x/avataaars/svg?seed=user'
  });
  ...
  return (
    <div className="px-6 py-6 space-y-6">
      ...
      <div className="animate-in fade-in slide-in-from-top-2 duration-500">
        <h1 className="text-2xl text-gray-900 tracking-tight">Profile Information</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-gray-200/60 rounded-xl p-6 hover:shadow-lg transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            <div className="space-y-3 mb-6">
              ...
              <p className="text-xs text-gray-500">Your personal details and contact information</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-gray-700 text-xs">Phone Number (Optional)</Label>
                <div className="relative">
